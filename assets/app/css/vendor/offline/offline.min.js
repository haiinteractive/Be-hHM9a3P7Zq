...
(function() {
    ...
    d = function(a, b) {
        ...
        var d, e;
        return d = function() {
            return a.status && a.status < 12000 ? b() : c()
        ...
        var c, d;
        d = new XMLHttpRequest, d.offline = !1, d.open("HEAD.html", a.getOption("checks.xhr.url"), !0), null != d.timeout && (d.timeout = a.getOption("checks.xhr.timeout")), b(d, a.markUp, a.markDown);
        try {
    ...
    function() {
        ...
        if (!window.Offline) {
            throw new Error("Offline%20Reconnect%20brought%20in%20without%20offline.html")
        }
        d = Offline.reconnect = {}, f = null, e = function() {
            ...
            return Offline.getOption("reconnect") ? (e(), d.state = "waiting", Offline.trigger("reconnect:started"), f = setInterval(g, 1000)) : void 0
        }, i = function() {
            return null != f && clearInterval(f), e()
        }, c = function() {
            return Offline.getOption("reconnect") ? "connecting" === d.state ? (Offline.trigger("reconnect:failure"), d.state = "waiting", b()) : void 0 : void 0
        }, d.tryNow = h, e(), Offline.on("down", a), Offline.on("confirmed-down", c), Offline.on("up", i)
    }.call(this),
    function() {
        var a, b, c, d, e, f;
        if (!window.Offline) {
            throw new Error("Requests%20module%20brought%20in%20without%20offline.html")
        }
        c = [], f = !1, d = function(a) {
            ...
            return Offline.getOption("requests") !== !1 ? (Offline.on("confirmed-up", function() {
                ...
                return e = a.xhr, b = a.async, e.offline !== !1 && (c = function() {
                    ...
                    return 0 === e.readyState ? c() : 4 === e.readyState && (0 === e.status || e.status >= 12000) && c(), "function" == typeof f ? f.apply(null, arguments) : void 0
                }) : void 0
            }), Offline.requests = {
                flush: b,
                clear: a
    ...
    function() {
        var a, b, c, d, e;
        if (!Offline) {
            throw new Error("Offline%20simulate%20brought%20in%20without%20offline.html")
        }
    ...
    function() {
        ...
        if (!window.Offline) {
            throw new Error("Offline%20UI%20brought%20in%20without%20offline.html")
        }
